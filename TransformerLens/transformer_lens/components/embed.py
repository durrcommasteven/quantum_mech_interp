...
class Embed(nn.Module):
    ...
    def forward(
        ...
        # our embeddings might be floats
        # this is hacky, but for now who cares
        # map the float component to a scaling number by un-sigmoiding it
        if tokens.dtype == torch.float32:
            ...
            outputs = self.W_E[long_tokens, :] * float_components.unsqueeze(-1)
